...
Original file is located at
    https://colab.research.google.com/drive/1D5Y-UjhmvO2xLI4qm20MsX7Yboz-0PeI
...
class TrainerGAN():
    def __init__(self, config):
        ...
        self.D = Discriminator(3, self.config)
    ...
    def train(self):
        ...
        for e, epoch in enumerate(range(self.config["n_epoch"])):
            ...
            if (e+1) % 5 == 0 or e == 0:
                ...
                self.CKPT_PATH = os.path.join(self.ckpt_dir, f'G_{e}.pth')
...
# trainer.inference(f'{workspace_dir}/checkpoints/2022-04-15_10-09-45_GAN/G_19.pth') # you have to modify the path when running this line
#trainer.inference(trainer.CKPT_PATH)
...
#files.download(f'./checkpoints/G_{config["n_epoch"]-1}.pth')
#files.download(f'./checkpoints/D_{config["n_epoch"]-1}.pth')
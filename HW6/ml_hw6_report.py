...
Original file is located at
    https://colab.research.google.com/drive/1yf-GZNr-nlzP3FrgG--V25gpRsc_iSlW
...
class Discriminator(nn.Module):
    ...
    def forward(self, x):
        y = self.l1(x)
        #print(self.l1[4][0].weight.shape) #512 256 4 4 
        
        #Conv2d_norm1.append(self.l1[2][0].weight.grad)
        #Conv2d_norm2.append(self.l1[3][0].weight.grad)
        #Conv2d_norm3.append(self.l1[4][0].weight.grad)
...
class TrainerGAN():
    def __init__(self, config):
        ...
        self.opt_D = torch.optim.RMSprop(self.D.parameters(), lr=self.config["lr"], alpha=0.99, eps=1e-08, weight_decay=0, momentum=0, centered=False)
        self.opt_G = torch.optim.RMSprop(self.G.parameters(), lr=self.config["lr"], alpha=0.99, eps=1e-08, weight_decay=0, momentum=0, centered=False)
    ...
    def train(self):
        ...
        for e, epoch in enumerate(range(self.config["n_epoch"])):
            ...
            for i, data in enumerate(progress_bar):
                ...
                global Conv2d_norm3
                global Conv2d_norm4        
                Conv2d_norm1=trainer.D.l1[0].weight.grad                                        
                Conv2d_norm2=trainer.D.l1[2][0].weight.grad
                Conv2d_norm3=trainer.D.l1[3][0].weight.grad
                Conv2d_norm4=trainer.D.l1[4][0].weight.grad
...
#Conv2d_norm1=trainer.D.l1[2][0].weight.grad
#Conv2d_norm2=trainer.D.l1[3][0].weight.grad
#Conv2d_norm3=trainer.D.l1[4][0].weight.grad
#Conv2d_norm4=trainer.D.l1[5].weight.grad
...
Conv2d_norm1_total=0
Conv2d_norm2_total=0
Conv2d_norm3_total=0
Conv2d_norm4_total=0

Conv2d_norm1_total = norm(Conv2d_norm1.cpu())

#print(Conv2d_norm1_total)
print('layer1: ')
print(math.log(Conv2d_norm1_total))


Conv2d_norm2_total = norm(Conv2d_norm2.cpu())

#print(Conv2d_norm2_total)
print('layer2: ')
print(math.log(Conv2d_norm2_total))


Conv2d_norm3_total = norm(Conv2d_norm3.cpu())

#print(Conv2d_norm3_total)
print('layer3: ')
print(math.log(Conv2d_norm3_total))


Conv2d_norm4_total = norm(Conv2d_norm4.cpu())

#print(Conv2d_norm3_total)
print('layer4: ')
print(math.log(Conv2d_norm4_total))
...
#trainer.inference(f'{workspace_dir}/checkpoints/2022-04-13_02-34-47_GAN/G_4.pth') # you have to modify the path when running this line

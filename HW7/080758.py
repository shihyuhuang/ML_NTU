...
for epoch in range(num_epoch):
    ...
    with open(f"./filename.txt","a") as filef:
        filef.write(f"Epoch {epoch + 1} | Step {step} | loss = {train_loss.item() / logging_step:.3f}, acc = {train_acc / logging_step:.3f}")
    ...
    if validation:
        ...
        with torch.no_grad():
            ...
            with open(f"./filename.txt","a") as filef:
                filef.write(f"Validation | Epoch {epoch + 1} | acc = {dev_acc / len(dev_loader):.3f}\n")

...
Original file is located at
    https://colab.research.google.com/drive/1aUzVonJTbS7eqgIAvAhZvjOKmmXX7v1i
...
class conv_autoencoder(nn.Module):
    def __init__(self):
        ...
        self.encoder1 = nn.Sequential(
            ...
            nn.ReLU(),
            #nn.ConvTranspose2d(256, 128, 4, stride=3, padding=4),
            #nn.ReLU(),
        )
        ...
        self.encoder2 = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Conv2d(48, 48, 4, stride=2, padding=1),        
            nn.ReLU(),
			nn.Conv2d(48, 96, 4, stride=2, padding=1),         
            nn.ReLU(),

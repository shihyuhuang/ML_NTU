# -*- coding: utf-8 -*-
"""「ML2022_hw10_ipynb」的副本.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Pbs7oG-l914vJkwp-2wuT-bFCvD37HP2
...
def mifgsm(model, x, y, loss_fn, epsilon=epsilon, alpha=alpha, num_iter=20, decay=1.0):
    ...
    for i in range(num_iter):
        x_adv = x_adv.detach().clone()
        x_adv.requires_grad = True # need to obtain gradient of x_adv, thus set required grad
        outputs = model(input_diversity(x_adv))
...
model_names = ['resnet56_cifar10','nin_cifar10','densenet100_k12_cifar10','densenet40_k12_cifar10',
...
attack = torchattacks.MIFGSM(model, eps=epsilon, steps=20, decay=1.0)

def gen_adv_examples2(model, loader, attack, loss_fn):
    model.eval()
    adv_names = []
    train_acc, train_loss = 0.0, 0.0
    for i, (x, y) in enumerate(loader):
...
'''
adv_examples, mifgsm_acc, mifgsm_loss = gen_adv_examples2(model, adv_loader, attack, loss_fn)
